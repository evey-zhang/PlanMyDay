...
public class LAAttractionListAdapter extends RecyclerView.Adapter<LAAttractionListAdapter.LAAttractionViewHolder> {
	...
	public static class LAAttractionViewHolder extends RecyclerView.ViewHolder {
		...
		public LAAttractionViewHolder(View v) {
			super(v);
	...
	public LAAttractionListAdapter(Context context, ArrayList<Attraction> attractionList) {
	...
	@NonNull
	@Override
	public LAAttractionListAdapter.LAAttractionViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
		View v = LayoutInflater.from(context)
				.inflate(R.layout.activity_attraction_list_cell, parent, false);
		return new LAAttractionViewHolder(v);
	}

	@Override
	public void onBindViewHolder(@NonNull LAAttractionListAdapter.LAAttractionViewHolder holder, int position) {
